...
const SkillsList = () => {
  ...
  return (
    <div className="text-left pt-3 md:pt-9">
      <div className="my-16 md:my-20 mx-auto text-center">
      ...
      <div className="flex flex-col md:flex-row justify-around items-start gap-10">
        <div>
          <h4 className="text-[var(--white)] font-bold text-lg md:text-xl md:mb-6">Software</h4>
          <ul className="space-y-4 mt-4 text-lg">
            {Object.entries(software).map(([category, items]) => (
              <li key={category} className="w-full">
                <div
                  onClick={() => toggleItem(category)}
                  className="md:w-[300px] w-full bg-[#1414149c] rounded-2xl text-left hover:bg-opacity-80 transition-all border border-[var(--white-icon-tr)] cursor-pointer overflow-hidden"
                >
        ...
        <div>
          <h4 className="text-[var(--white)] font-bold text-lg md:text-xl md:mb-6">Web3</h4>
          <ul className="space-y-4 mt-4 text-lg">
        ...
        <div>
          <h4 className="text-[var(--white)] font-bold text-lg md:text-xl md:mb-6">DevOps</h4>
          <ul className="space-y-4 mt-4 text-lg">
